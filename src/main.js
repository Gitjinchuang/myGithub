...
var store = new Vuex.Store({
    ...
    mutations:{
        ...
        colleges_data: function (state,data) {
          
            state.colleges_data_obj = data
            //console.log(state.colleges_data_obj)
           
        },
        colleges_name_data: function (state, data) {
            state.colleges_name_obj = data
        }
    },
    getters:{
